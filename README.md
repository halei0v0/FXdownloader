...
FXdownloader 是一款基于开源项目优化重构的番茄小说下载工具，支持图形用户界面（GUI）和命令行两种操作模式，具备稳定的下载性能、完善的错误处理和友好的用户体验，帮助用户便捷获取番茄小说资源并导出为 TXT、EPUB 格式。【源码推迟公布，因为那电脑拿去修了】
...
6. **自动更新**：内置版本检查与自动更新模块，及时获取功能优化和 Bug 修复。
7. **源码来源**：https://github.com/POf-L/Fanqie-novel-Downloader
